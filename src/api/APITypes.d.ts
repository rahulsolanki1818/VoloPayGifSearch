interface SearchTagsParam {
  q: string;
}

interface SearchImagesParam {
  q: string;
  limit: number;
  offset: number;
  lang: string;
...
type SearchTagsResponse = CommonReponse<Array<Tag>>;
...
type SearchImagesResponse = CommonReponse<Array<ImageSearch>>;
